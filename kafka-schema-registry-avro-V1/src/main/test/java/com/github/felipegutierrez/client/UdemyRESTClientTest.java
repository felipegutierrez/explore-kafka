package com.github.felipegutierrez.client;

import com.github.felipegutierrez.avro.udemy.Course;
import com.github.felipegutierrez.avro.udemy.Review;
import com.github.felipegutierrez.avro.udemy.User;
import com.github.felipegutierrez.model.ReviewApiResponse;
...
//        assertEquals(review.getModified(), DateTime.parse("2017-03-31T21:23:04Z"));
        assertEquals(review.getCreated(), Instant.parse("2017-03-30T20:13:54Z"));
        assertEquals(review.getModified(), Instant.parse("2017-03-31T21:23:04Z"));
    ...
    public void canParseCourseJson() {
        ...
        assertEquals(course.getId(), 1075642L);

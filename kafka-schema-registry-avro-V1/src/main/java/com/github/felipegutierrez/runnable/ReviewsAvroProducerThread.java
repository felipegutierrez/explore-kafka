package com.github.felipegutierrez.runnable;
...
public class ReviewsAvroProducerThread implements Runnable {
    private final Logger log = LoggerFactory.getLogger(ReviewsAvroProducerThread.class.getSimpleName());
    ...
    public ReviewsAvroProducerThread(UdemyConfig appConfig,
    ...
    public KafkaProducer<Long, Review> createKafkaProducer(UdemyConfig appConfig) {
